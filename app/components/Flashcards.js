    ...
    return (
      <div tabIndex="0" className="sn-component" onKeyDown={this.onKeyDown} onKeyUp={this.onKeyUp}>
        ...
        <div className="sk-button-group">
            ...
            <button type="button" id="settingsButton" onClick={this.onToggleShowSettings, this.getRandomCardList} title="Settings" className={"sk-button"}>
              <div className="sk-label">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
